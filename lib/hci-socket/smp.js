...
Smp.prototype.handlePairingResponse = function (data) {
  ...
  if (!this._preq) {
    debug('handlePairingResponse: this._preq not set. we did not initiate this so not responding...');
    return;
  }
...
Smp.prototype.handlePairingConfirm = function (data) {
  ...
  if (!this._r) {
    debug('handlePairingConfirm: this._r not set. we did not initiate this so not responding...');
    return;
  }
...
Smp.prototype.handlePairingRandom = function (data) {
  ...
  if (!this._preq) {
    debug('handlePairingRandom: this._preq not set. we did not initiate this so not responding...');
    return;
  }
